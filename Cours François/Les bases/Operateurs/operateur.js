...
let resultat = null;
resultat = premierNombre + deuxiemeNombre; //ici le resultat donnera 510 car on ajoute un nb et une chaine de caracteres
...
console.log("Boucle for");
//zz est la variable qui sert de compteur je peux la définir en dehors de ma boucle
let zz = 20
for (zz; zz < 24; zz++){
    console.log(zz);
}
